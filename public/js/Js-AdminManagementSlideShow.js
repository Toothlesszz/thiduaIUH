...
imageCheckboxes.forEach((checkbox) => {
  ...
  if (checkbox.checked) {
    // Tìm phần tử <img> liên quan bằng cách sử dụng closest hoặc querySelector
    const image = checkbox.parentElement.parentElement.querySelector("img");

    // Kiểm tra xem có hình ảnh không và lấy src nếu có
    if (image) {
