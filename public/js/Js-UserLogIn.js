...
function validationId(isId) {
    var regId = /^[0-9]+$/;
    if (!regId.test(isId.value)) {
        isId.classList.add("input-danger");
        validationFormId = false;
        return "Mã ứng viên phải dãy là số!";
    } else {
        isId.classList.remove("input-danger");
