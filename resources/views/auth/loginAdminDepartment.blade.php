...
<head>
    ...
    <link rel="icon" href="../Icon/icon-award.png" />
...
<body>
    ...
    <section class="login">
        ...
        <div class="login__form">
            ...
            <p class="custom-text-green-s">
                Trang đăng nhập dành cho Quản trị viên Khoa !
            </p>
            @if(session('error')) 
          <script>
        ...
        if (reloadStatus === "true") {
          ...
          MessageError(
            "ĐĂNG NHẬP KHÔNG THÀNH CÔNG!",
            "Tài khoản của bạn đã bị khóa, vui lòng liên hệ Văn phòng Đoàn trường ."
          );
          // Xóa trạng thái đã được lưu trữ
          sessionStorage.removeItem("reloadStatus");
        }
        ...
        @endif
            <form action="login-admin-department" method="POST">
            @csrf
                ...
                <div class="login__form--btn">
                    <div class="">
                        <input class="custom-checkbox" name = "remember" type="checkbox" id="checkbox2" />
    ...
    <script src="./js/Js-AdminLogIn.js"></script>
